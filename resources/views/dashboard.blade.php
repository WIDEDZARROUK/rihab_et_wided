  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{route('listdelivery')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">
              <span class="material-symbols-outlined">
              person
      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"></span>totales des produits</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"></span>totales des utilisateur </p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-danger text-sm font-weight-bolder"></span>totales des commentaires</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            ...
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"></span>totales des commandes </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2  ">
            ...
            <div class="card-body">
              ...
              <p class="text-sm "> <span class="font-weight-bolder">0 : </span> Commandes Non Accepter</p>
              <p class="text-sm "> <span class="font-weight-bolder">1 : </span> Commandes Accepter</p>
        ...
        <div class="col-lg-4 mt-4 mb-3">
          <div class="card z-index-2 ">
            ...
            <h6 class="mb-0 ">Les Produits :</h6><br>
              <p class="text-sm "> <span class="font-weight-bolder">0 : </span> Produits Non Accepter</p>
              <p class="text-sm "> <span class="font-weight-bolder">1 : </span> Produits Accepter</p>
