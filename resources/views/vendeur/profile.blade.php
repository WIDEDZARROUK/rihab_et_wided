  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/products/create')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="row">
                   ...
                   <div class="row">
                     <div class="col-md-5 pr-1">
                       ...
                       <label for="nomsociete">nom de société </label>
                         <input type="text" class="form-control"  id ="nomsociete"  name="nomsociete"  value="{{Auth::user()->nomsociete}}" >
                        </div>
                     </div>
                   ...
                   <div class="row">
                     <div class="col-md-6 pr-1">
                       ...
                       <label for="numerosiret"> numéro de série de la sociétéde </label>
                         <input type="text" class="form-control" placeholder="number serial society" id="numerosiret" name="numerosiret" value="{{Auth::user()->numerosiret}}">
                       </div>
                     </div>
                     ...
                     <div class="col-md-6 pl-1">
                       ...
                       <label for="numerocart">numéro de carte</label>
                         <input type="text" class="form-control" id="numerocart" name="numerocart" value="{{Auth::user()->numerocart}}">
                       </div>
                     </div>
                   </div>
                   <br>
            ...
            <label for="password">Mot de passe (désactivé)</label>
             <input type="text" class="form-control" disabled="" id="password" name="password" value="********">
               ...
               <label for="description">À propos de Soucity </label>
                         <textarea class="form-control textarea" id="description" name="description" value="{{Auth::user()->description}}"></textarea>
