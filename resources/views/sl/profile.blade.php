      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ url('/livreurs') }}">
            ...
            <span class="nav-link-text ms-1">Deliverys Table</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/livreurs/create')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">Add New Delivery</span>
          </a>
        </li>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Vendor Profile</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Vendor Profile</h6>
        </nav>
                ...
                <form action="{{route('acc.update')}}" method="POST">
                   ...
                   <div class="row">
                     <div class="col-md-5 pr-1">
                       ...
                       <label for="nomsociete">society name</label>
                         <input type="text" class="form-control"  placeholder="society name" id ="nomsociete"  name="nomsociete"  value="{{Auth::user()->nomsociete}}" >
                       </div>
                     </div>
                     <div class="col-md-3 px-1">
                       <div class="form-group">
                       <label for="name"> Name </label>
                         <input type="text" class="form-control" placeholder="" id="name" name="name" value="{{ Auth::user()->name }}">
                       </div>
                     </div>
                     <div class="col-md-4 pl-1">
                       <div class="form-group">
                       <label for="email">Email </label>
                         <input type="text" class="form-control" placeholder="" id="email" name="email" value="{{ Auth::user()->email }}" >
                       </div>
                     </div>
                   </div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6 pl-1">
                       ...
                       <label for="phone">Phone number</label>
                         <input type="text" class="form-control" placeholder="Phone number" id="phone" name="phone" value="{{Auth::user()->phone}}" >
                        </div>
                     </div>
                   </div>
                   <br>
                   ...
                   <div class="row">
                     <div class="col-md-6 pr-1">
                       <div class="form-group">
                       <label for="imagevendeur">Picture</label>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="http://127.0.0.1:8000/" class="nav-link text-muted" target="_blank">Homepage</a>
                </li>
                <li class="nav-item">
