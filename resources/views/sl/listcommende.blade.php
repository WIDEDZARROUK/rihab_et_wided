      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ url('/livreurs') }}">
            ...
            <span class="nav-link-text ms-1">Delivery Table </span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/livreurs/create')}}">
            ...
            <span class="nav-link-text ms-1">Add New Delevery</span>
          </a>
        </li>
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Commands Table</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1">The Commands </span> completed successfully
                  </p>
                </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Qantity</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">societe Name </th>
