    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">PAGES DE COMPTE</h6>
        </li>
                   ...
                   <div class="row">
                     <div class="col-md-6 pr-1">
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" placeholder=" (+216)" id="phone" name="phone"
                ...
                <img id="previewImg" alt="profile image" src="../assets/img/addc.png" style="max-width:100px;margin-top:20px;" />
                   ...
                   <div class="row">
                     <div class="update ml-auto mr-auto">
                       <button type="submit" class="btn btn-primary btn-round">Mise a jour Profile</button>
                     </div>
                   </div>
                 </form>
              </div>
