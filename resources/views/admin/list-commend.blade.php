  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="{{route('listcommend')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">
              <span class="material-symbols-outlined">
              add_business
            ...
            <span class="nav-link-text ms-1">List Commend</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{ route('noconfirmedproducts')}}">
            ...
            <span class="nav-link-text ms-1">Touts les Produit</span>
          </a>
        </li>
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Table de Commandes</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1"> Les commandes </span> se sont terminées avec succès
                  </p>
                </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach($commadmins as $commadmin)
                    ...
                    {{$commadmin->nom_soc}}
                     ...
                     <td align="center">
                     <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="refusecommande/{{$commadmin->id}}"><i class="material-icons text-sm me-2">delete</i>Refuse</a>
