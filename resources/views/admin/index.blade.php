          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="http://127.0.0.1:8000/" class="font-weight-bold" target="_blank">Rihab & Wided</a>
                pour BBC.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="http://127.0.0.1:8000/" class="nav-link text-muted" target="_blank">page d'accueil</a>
                </li>
                <li class="nav-item">
