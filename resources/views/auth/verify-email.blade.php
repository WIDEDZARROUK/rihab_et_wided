  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('../assets/img/delivery11.png');">
      ...
      <div class="container my-auto">
        ...
        @endif
         <a href="#">Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly send you another.
</a> </br>provided by samser tounsi. <i class="fas fa-user-circle opacity-6 text-dark me-1"></i></p>
